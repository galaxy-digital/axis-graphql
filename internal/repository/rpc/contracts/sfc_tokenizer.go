...
var SfcTokenizerMetaData = &bind.MetaData{
	ABI: "[{\"constant\":false,\"inputs\":[{\"internalType\":\"address\",\"name\":\"addr\",\"type\":\"address\"}],\"name\":\"_updateSAXISTokenAddress\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[{\"internalType\":\"address\",\"name\":\"sender\",\"type\":\"address\"},{\"internalType\":\"uint256\",\"name\":\"stakerID\",\"type\":\"uint256\"}],\"name\":\"allowedToWithdrawStake\",\"outputs\":[{\"internalType\":\"bool\",\"name\":\"\",\"type\":\"bool\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[{\"internalType\":\"address\",\"name\":\"sender\",\"type\":\"address\"},{\"internalType\":\"uint256\",\"name\":\"stakerID\",\"type\":\"uint256\"}],\"name\":\"checkAllowedToWithdrawStake\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[{\"internalType\":\"uint256\",\"name\":\"stakerID\",\"type\":\"uint256\"},{\"internalType\":\"uint256\",\"name\":\"amount\",\"type\":\"uint256\"}],\"name\":\"redeemSAXIS\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"},{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"name\":\"outstandingSAXIS\",\"outputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[],\"name\":\"sAXISTokenAddress\",\"outputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[],\"name\":\"renounceOwnership\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[],\"name\":\"initialize\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[],\"name\":\"owner\",\"outputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[],\"name\":\"isOwner\",\"outputs\":[{\"internalType\":\"bool\",\"name\":\"\",\"type\":\"bool\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[{\"internalType\":\"uint256\",\"name\":\"toStakerID\",\"type\":\"uint256\"}],\"name\":\"mintSAXIS\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[{\"internalType\":\"address\",\"name\":\"newOwner\",\"type\":\"address\"}],\"name\":\"transferOwnership\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"anonymous\":false,\"inputs\":[{\"indexed\":true,\"internalType\":\"address\",\"name\":\"previousOwner\",\"type\":\"address\"},{\"indexed\":true,\"internalType\":\"address\",\"name\":\"newOwner\",\"type\":\"address\"}],\"name\":\"OwnershipTransferred\",\"type\":\"event\"}]",
}
...
// OutstandingSAXIS is a free data retrieval call binding the contract method 0x5b04f4c8.
//
// Solidity: function outstandingSAXIS(address , uint256 ) view returns(uint256)
func (_SfcTokenizer *SfcTokenizerCaller) OutstandingSAXIS(opts *bind.CallOpts, arg0 common.Address, arg1 *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _SfcTokenizer.contract.Call(opts, &out, "outstandingSAXIS", arg0, arg1)
...
//
// Solidity: function outstandingSAXIS(address , uint256 ) view returns(uint256)
func (_SfcTokenizer *SfcTokenizerSession) OutstandingSAXIS(arg0 common.Address, arg1 *big.Int) (*big.Int, error) {
	return _SfcTokenizer.Contract.OutstandingSAXIS(&_SfcTokenizer.CallOpts, arg0, arg1)
}

// OutstandingSAXIS is a free data retrieval call binding the contract method 0x5b04f4c8.
//
// Solidity: function outstandingSAXIS(address , uint256 ) view returns(uint256)
func (_SfcTokenizer *SfcTokenizerCallerSession) OutstandingSAXIS(arg0 common.Address, arg1 *big.Int) (*big.Int, error) {
	return _SfcTokenizer.Contract.OutstandingSAXIS(&_SfcTokenizer.CallOpts, arg0, arg1)
}
...
// SAXISTokenAddress is a free data retrieval call binding the contract method 0x693c5e24.
//
// Solidity: function sAXISTokenAddress() view returns(address)
func (_SfcTokenizer *SfcTokenizerCaller) SAXISTokenAddress(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _SfcTokenizer.contract.Call(opts, &out, "sAXISTokenAddress")
...
//
// Solidity: function sAXISTokenAddress() view returns(address)
func (_SfcTokenizer *SfcTokenizerSession) SAXISTokenAddress() (common.Address, error) {
	return _SfcTokenizer.Contract.SAXISTokenAddress(&_SfcTokenizer.CallOpts)
}

// SAXISTokenAddress is a free data retrieval call binding the contract method 0x693c5e24.
//
// Solidity: function sAXISTokenAddress() view returns(address)
func (_SfcTokenizer *SfcTokenizerCallerSession) SAXISTokenAddress() (common.Address, error) {
	return _SfcTokenizer.Contract.SAXISTokenAddress(&_SfcTokenizer.CallOpts)
}

// UpdateSAXISTokenAddress is a paid mutator transaction binding the contract method 0x06f03e22.
//
// Solidity: function _updateSAXISTokenAddress(address addr) returns()
func (_SfcTokenizer *SfcTokenizerTransactor) UpdateSAXISTokenAddress(opts *bind.TransactOpts, addr common.Address) (*types.Transaction, error) {
	return _SfcTokenizer.contract.Transact(opts, "_updateSAXISTokenAddress", addr)
}

// UpdateSAXISTokenAddress is a paid mutator transaction binding the contract method 0x06f03e22.
//
// Solidity: function _updateSAXISTokenAddress(address addr) returns()
func (_SfcTokenizer *SfcTokenizerSession) UpdateSAXISTokenAddress(addr common.Address) (*types.Transaction, error) {
	return _SfcTokenizer.Contract.UpdateSAXISTokenAddress(&_SfcTokenizer.TransactOpts, addr)
}

// UpdateSAXISTokenAddress is a paid mutator transaction binding the contract method 0x06f03e22.
//
// Solidity: function _updateSAXISTokenAddress(address addr) returns()
func (_SfcTokenizer *SfcTokenizerTransactorSession) UpdateSAXISTokenAddress(addr common.Address) (*types.Transaction, error) {
	return _SfcTokenizer.Contract.UpdateSAXISTokenAddress(&_SfcTokenizer.TransactOpts, addr)
}
...
// MintSAXIS is a paid mutator transaction binding the contract method 0xca2d6fd8.
//
// Solidity: function mintSAXIS(uint256 toStakerID) returns()
func (_SfcTokenizer *SfcTokenizerTransactor) MintSAXIS(opts *bind.TransactOpts, toStakerID *big.Int) (*types.Transaction, error) {
	return _SfcTokenizer.contract.Transact(opts, "mintSAXIS", toStakerID)
}

// MintSAXIS is a paid mutator transaction binding the contract method 0xca2d6fd8.
//
// Solidity: function mintSAXIS(uint256 toStakerID) returns()
func (_SfcTokenizer *SfcTokenizerSession) MintSAXIS(toStakerID *big.Int) (*types.Transaction, error) {
	return _SfcTokenizer.Contract.MintSAXIS(&_SfcTokenizer.TransactOpts, toStakerID)
}

// MintSAXIS is a paid mutator transaction binding the contract method 0xca2d6fd8.
//
// Solidity: function mintSAXIS(uint256 toStakerID) returns()
func (_SfcTokenizer *SfcTokenizerTransactorSession) MintSAXIS(toStakerID *big.Int) (*types.Transaction, error) {
	return _SfcTokenizer.Contract.MintSAXIS(&_SfcTokenizer.TransactOpts, toStakerID)
}

// RedeemSAXIS is a paid mutator transaction binding the contract method 0x4a37ec9d.
//
// Solidity: function redeemSAXIS(uint256 stakerID, uint256 amount) returns()
func (_SfcTokenizer *SfcTokenizerTransactor) RedeemSAXIS(opts *bind.TransactOpts, stakerID *big.Int, amount *big.Int) (*types.Transaction, error) {
	return _SfcTokenizer.contract.Transact(opts, "redeemSAXIS", stakerID, amount)
}

// RedeemSAXIS is a paid mutator transaction binding the contract method 0x4a37ec9d.
//
// Solidity: function redeemSAXIS(uint256 stakerID, uint256 amount) returns()
func (_SfcTokenizer *SfcTokenizerSession) RedeemSAXIS(stakerID *big.Int, amount *big.Int) (*types.Transaction, error) {
	return _SfcTokenizer.Contract.RedeemSAXIS(&_SfcTokenizer.TransactOpts, stakerID, amount)
}

// RedeemSAXIS is a paid mutator transaction binding the contract method 0x4a37ec9d.
//
// Solidity: function redeemSAXIS(uint256 stakerID, uint256 amount) returns()
func (_SfcTokenizer *SfcTokenizerTransactorSession) RedeemSAXIS(stakerID *big.Int, amount *big.Int) (*types.Transaction, error) {
	return _SfcTokenizer.Contract.RedeemSAXIS(&_SfcTokenizer.TransactOpts, stakerID, amount)
}
